...
var AdblockDetector = {
    ...
    _detectCallback: function(success) {
        var msg = success ? 1 : 0;
        wasmTable.get(AdblockDetector._callback)(msg)
    }
};
function _AdsDetector_Detect(callback) {
...
function _GameDistribution_PlatformHideDisplayAd(containerId) {
...
function _GameDistribution_PlatformInit(gameId, debug) {
    window["GD_DEFOLD"] = {
        "onEvent": function(event) {
            ...
            wasmTable.get(listener)(allocate(intArrayFromString(event.name), "i8", ALLOC_STACK), allocate(intArrayFromString(event.message), "i8", ALLOC_STACK))
        }
    }
}
function _GameDistribution_PlatformOpenConsole() {
    if (typeof gdsdk !== "undefined" && gdsdk.openConsole !== "undefined") {
        gdsdk.openConsole()
    }
}
function _GameDistribution_PlatformSetEventListener(listener) {
    Context.listener = listener
}
function _GameDistribution_PlatformShowDisplayAd(containerId) {
    var elementId = UTF8ToString(containerId);
    var element = document.getElementById(elementId);
    if (typeof element === "undefined") {
        console.log("Unable to find element with id " + elementId);
    ...
    if (typeof gdsdk !== "undefined" && gdsdk.showAd !== "undefined") {
        ...
        }).then(()=>console.info("showAd(AdType.Display) resolved.")).catch(error=>console.error(error))
    }
}
function _GameDistribution_PlatformShowInterstitialAd() {
    if (typeof gdsdk !== "undefined" && gdsdk.showAd !== "undefined") {
        var activeElement = document.activeElement;
        if (activeElement) {
            Context.activeElementId = document.activeElement.id
        }
        gdsdk.showAd(gdsdk.AdType.Interstitial).then(()=>console.info("showAd(AdType.Interstitial) resolved.")).catch(error=>console.error(error))
    }
}
function _GameDistribution_PlatformShowRewardedAd() {
    if (typeof gdsdk !== "undefined" && gdsdk.showAd !== "undefined") {
        var activeElement = document.activeElement;
        if (activeElement) {
            Context.activeElementId = document.activeElement.id
        }
        gdsdk.showAd(gdsdk.AdType.Rewarded).then(()=>console.info("showAd(AdType.Rewarded) resolved.")).catch(error=>console.error(error))
    }
}
function _GameDistribution_PlatformShowSendGameEvent(levelText, scoreText) {
    if (typeof gdsdk !== "undefined" && gdsdk.showAd !== "undefined") {
        ...
        if (typeof level !== "undefined" && typeof score !== "undefined") {
            ...
            gdsdk.sendEvent(obj).then(()=>console.info("sendEvent resolved.")).catch(error=>console.error(error))
        }
    }
}
...
function _ShareFile(data, type, name, title, text, url) {
    if (navigator && navigator.share) {
        try {
            ...
            var shareData = {
                files: [new File([file_data],file_name,{
                    type: mime_type
                })],
                title: file_title,
                text: file_text,
...
function _ShareImage(data, size, text, name) {
    if (navigator && navigator.share) {
        try {
            var file_data = data ? UTF8ToString(data) : "";
            var file_text = text ? UTF8ToString(text) : undefined;
            ...
            var shareData = {
                files: [new File([image_data],file_name,{
                    type: mime_type
                })],
                title: file_name,
                text: file_text
...
function _ShareLog_Init() {
    if (typeof ShareLog !== "undefined") {
        ShareLog.subscribe()
    }
}
function _ShareText(data) {
    if (navigator && navigator.share) {
        try {
...
function _dmSysOpenURL(url, target) {
    ...
    if (window.xopen(jsurl, jstarget) == null) {
...
var asmLibraryArg = {
    "di": _AdsDetector_Detect,
    "ci": _GameDistribution_PlatformHideDisplayAd,
    "bi": _GameDistribution_PlatformInit,
    "ai": _GameDistribution_PlatformOpenConsole,
    "$h": _GameDistribution_PlatformSetEventListener,
    "_h": _GameDistribution_PlatformShowDisplayAd,
    "Zh": _GameDistribution_PlatformShowInterstitialAd,
    "Yh": _GameDistribution_PlatformShowRewardedAd,
    "Xh": _GameDistribution_PlatformShowSendGameEvent,
    "Wh": _HtmlLoaderLibrary_Hide,
    "Vh": _HtmlLoaderLibrary_SetProgress,
    "Uh": _HtmlLoaderLibrary_SetText,
    "Th": _HtmlLoaderLibrary_Show,
    "Sh": _ShareFile,
    "Rh": _ShareImage,
    "Qh": _ShareLog_Init,
    "Ph": _ShareText,
    ...
    "sh": _dmResZipRequestFileAsync,
    "rh": _dmScriptHttpRequestAsync,
    "qh": _dmSysGetApplicationPath,
    "ph": _dmSysGetUserAgent,
    "oh": _dmSysGetUserPersistentDataRoot,
    "nh": _dmSysGetUserPreferredLanguage,
    "mh": _dmSysOpenURL,
    ...
    "Yb": _glColorMask,
    "M": _glCompileShader,
    "p": _glCompressedTexImage2D,
    "Xb": _glCompressedTexImage3D,
    "o": _glCompressedTexSubImage2D,
    ...
    "Ab": _glPolygonOffset,
    "zb": _glReadPixels,
    "U": _glRenderbufferStorage,
    "yb": _glScissor,
    "H": _glShaderSource,
    "xb": _glStencilFunc,
    "wb": _glStencilFuncSeparate,
    "vb": _glStencilMask,
    "ub": _glStencilOp,
    ...
    "ma": _glUseProgram,
    "la": _glVertexAttribPointer,
    "mb": _glViewport,
    "lb": _glfwAccelerometerEnable,
    "kb": _glfwCloseWindow,
    "jb": _glfwDisable,
    "ib": _glfwEnable,
    "hb": _glfwGetAcceleration,
    "ka": _glfwGetDefaultFramebuffer,
    "gb": _glfwGetDisplayScaleFactor,
    "fb": _glfwGetJoystickButtons,
    "eb": _glfwGetJoystickDeviceId,
    "db": _glfwGetJoystickHats,
    "F": _glfwGetJoystickParam,
    "cb": _glfwGetJoystickPos,
    "bb": _glfwGetKey,
    "l": _glfwGetMouseButton,
    "ab": _glfwGetMouseLocked,
    "$a": _glfwGetMousePos,
    "_a": _glfwGetMouseWheel,
    "T": _glfwGetProcAddress,
    "Za": _glfwGetWindowParam,
    "Ya": _glfwGetWindowRefreshRate,
    "ja": _glfwGetWindowSize,
    "Xa": _glfwIconifyWindow,
    "Wa": _glfwInitJS,
    "Va": _glfwOpenWindow,
    "S": _glfwOpenWindowHint,
    "Ua": _glfwPollEvents,
    "Ta": _glfwResetKeyboard,
    "Sa": _glfwSetCharCallback,
    "Ra": _glfwSetDeviceChangedCallback,
    "Qa": _glfwSetGamepadCallback,
    "Pa": _glfwSetMarkedTextCallback,
    "Oa": _glfwSetTouchCallback,
    "Na": _glfwSetWindowBackgroundColor,
    "Ma": _glfwSetWindowCloseCallback,
    "La": _glfwSetWindowFocusCallback,
    "Ka": _glfwSetWindowIconifyCallback,
    "ia": _glfwSetWindowSize,
    "Ja": _glfwSetWindowSizeCallback,
    "ha": _glfwShowKeyboard,
    "Ia": _glfwSwapBuffers,
...
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function() {
    return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["fi"]).apply(null, arguments)
}
;
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function() {
    return (_dmExportedSymbols = Module["_dmExportedSymbols"] = Module["asm"]["gi"]).apply(null, arguments)
}
;
var _main = Module["_main"] = function() {
    return (_main = Module["_main"] = Module["asm"]["hi"]).apply(null, arguments)
}
;
var _malloc = Module["_malloc"] = function() {
    return (_malloc = Module["_malloc"] = Module["asm"]["ii"]).apply(null, arguments)
}
;
var _free = Module["_free"] = function() {
    return (_free = Module["_free"] = Module["asm"]["ji"]).apply(null, arguments)
}
;
var _htonl = Module["_htonl"] = function() {
    return (_htonl = Module["_htonl"] = Module["asm"]["ki"]).apply(null, arguments)
}
;
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function() {
    return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = Module["asm"]["li"]).apply(null, arguments)
}
;
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function() {
    return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = Module["asm"]["mi"]).apply(null, arguments)
}
;
...
var _htons = Module["_htons"] = function() {
    return (_htons = Module["_htons"] = Module["asm"]["oi"]).apply(null, arguments)
}
;
var _ntohs = Module["_ntohs"] = function() {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["pi"]).apply(null, arguments)
}
;
var _JSWriteDump = Module["_JSWriteDump"] = function() {
    return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["qi"]).apply(null, arguments)
}
;
var __get_tzname = Module["__get_tzname"] = function() {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["ri"]).apply(null, arguments)
}
;
var __get_daylight = Module["__get_daylight"] = function() {
    return (__get_daylight = Module["__get_daylight"] = Module["asm"]["si"]).apply(null, arguments)
}
;
var __get_timezone = Module["__get_timezone"] = function() {
    return (__get_timezone = Module["__get_timezone"] = Module["asm"]["ti"]).apply(null, arguments)
}
;
...
var stackRestore = Module["stackRestore"] = function() {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["vi"]).apply(null, arguments)
}
;
var stackAlloc = Module["stackAlloc"] = function() {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["wi"]).apply(null, arguments)
}
;
var _setThrew = Module["_setThrew"] = function() {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["xi"]).apply(null, arguments)
}
;
var dynCall_jii = Module["dynCall_jii"] = function() {
    return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["yi"]).apply(null, arguments)
}
;
