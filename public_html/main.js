(function () {
    ...
    ShareLog.subscribe = function () {
        ...
        // 
        catch_promise_errors = 'true' === 'true' || 'true' === '1';
        // 

        function wrappFunction(func) {
            var wrapped = function () {
              // console.trace("--fx--wrappFunction--wrapped--", func)
    ...
    function downloadIOS(data, filename) {
        ...
        //     // window.xopen(uriContent, 'neuesDokument');
    ...
    // 
    force_html5_init = 'false' === 'true' || 'false' === '1';
    // 
