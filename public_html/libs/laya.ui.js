!function(t, e) {
    ...
    class y extends c {
        constructor() {
            super(...arguments), this.selectEnable = !0, this.totalPage = 0, this._$componentType = "List", 
    ...
    class Y extends e.Scene {
        ...
        static __init__() {
            e.ILaya.ClassUtils.regShortClassName([ B, d, M, p, c, O, u, g, b, n, S, T, o, C, y, z, w, x, E, m, v, I, k, Y, f, U, D, A, N, e.Animation, e.Text, P ]);
        }
